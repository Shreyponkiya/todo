...
module.exports = async (req, res) => {
  try {
    console.log('🔔 Vercel Cron: Night email triggered at', new Date().toISOString());
    ...
    console.log('✅ Night email sent successfully');
    res.status(200).json({ success: true, result, timestamp: new Date().toISOString() });
  } catch (error) {
    console.error('❌ Night email error:', error.message);
